  ...
  return (
    <aside className={clsx(
      ...
      <nav className="p-1 space-y-1 shrink-0">
        ...
        <Button variant="ghost" className="w-full justify-start cursor-pointer p-1 border-t border-b">
      ...
      <div className="flex-1 mt-1 border-t border-b shrink-0">
        ...
        <ScrollArea className="flex-1 px-2 overflow-y-auto mt-2">
        {/*h-[calc(100vh-220px)]*/}
            ...
            {assessments.map(a => (
              <li key={a.id}> 
                <button
                  ...
                  className="bg-white p-2 rounded-md shadow-sm hover:shadow-md transition 
                             cursor-pointer"
                >
